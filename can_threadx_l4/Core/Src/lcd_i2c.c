...
/// Used for debug i2c errors ///
//static uint32_t i2c_err = 0;
//
//static void ExpanderWrite(uint8_t _data)
//{
//  uint8_t data = _data | dpBacklight;
//  if (HAL_I2C_Master_Transmit(&hi2c1, DEVICE_ADDR, &data, 1, 10) != HAL_OK) {
//    i2c_err++;
//  }
//}
...
// debug i2c lcd errors //
//uint32_t lcd_get_i2c_err(void) { return i2c_err; }
